...
def get_pairs_from_paths( images_path , segs_path ):
	...
	for im in images:
		seg_bnme = os.path.basename(im).replace(".jpg" , ".png").replace(".jpeg" , ".png").replace(".bmp" , ".png")
...
def get_image_arr( path , width , height , imgNorm="divide" , odering='channels_first' ):
